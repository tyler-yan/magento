    ...
    <div class="main">
      ...
      <div class="content" id="content">
        <div class="title">
         ...
         <h3> <span><?php echo ($web["date"]); ?></span> <?php  $arrTags=array(); $tagStrs=""; $tagStr=$web["tags"];if($tagStr!=null&&$tagStr!=""){ $arrTags=explode(",", $tagStr); } for ($i=0; $i <count($arrTags); $i++) { echo "<span class='lable'>".$arrTags[$i]."</span> "; }?>
