    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <!-- 获取当前的模块操作 -->
              <?php  $controller=explode('/','/Admin/Web/addinfo')[2];?>
      ...
      <form id="form-addInfo" class="form-horizontal" role="form" action="/Admin/Web/saveInfo" >
        ...
        <br>
         ...
         <div class="form-group">
          ...
          <div class="col-sm-2">
              <input type="text" class="form-control input-lg" id="website_name" placeholder="网站" readonly="readonly"/>
          </div>
         <div class="col-sm-5 input-lg">
            <div class="input-group ">
              <input  type="text" class="form-control input-lg" id="website_link"  placeholder="http://www." readonly="readonly"/>
