  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <!-- 获取当前的模块操作 -->
              <?php  $controller=explode('/','/Admin/Tag/editinfo?_id=2')[2];?>
   ...
   <div class="main-container">
      ...
      <form id="form-addInfo" class="form-horizontal" role="form" action="/Admin/Tag/saveInfo" >
        <input type="hidden" name="dbid" value="<?php echo ($tag["dbid"]); ?>"/>
        </br>
        <div class="form-group">
          <label class="col-sm-2 control-label input-lg">标签</label>
          <div class="col-sm-7">
            <input type="text" class="form-control input-lg" name="tag" placeholder="Tag" datatype="*1-6" errormsg="<i class='icon-warning-sign'></i> 标题在1~6位之间" ajaxurl="validName"  value="<?php echo ($tag["tag"]); ?>" nullmsg="<i class='icon-warning-sign'></i> 请填写标签." />
          </div>
