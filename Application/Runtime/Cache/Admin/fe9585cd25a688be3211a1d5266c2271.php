  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <!-- 获取当前的模块操作 -->
              <?php  $controller=explode('/','/Admin/Blog/editinfo?_id=3')[2];?>
   ...
   <div class="main-container">
      ...
      <div class="projects-header page-header">
          <h3><i class="icon-plus"></i> 编辑</h3>
      </div>

      <!-- 添加表单 -->
      <form id="form-addInfo" class="form-horizontal" role="form" action="/Admin/Blog/saveInfo" >
        <input type="hidden" name="dbid" value="<?php echo ($blog["dbid"]); ?>"/>
        </br>
        <div class="form-group">
          <label class="col-sm-0 control-label input-lg">标题</label>
          <div class="col-sm-8">
            <input type="text" class="form-control input-lg" name="title" placeholder="标题" datatype="*4-32" errormsg="<i class='icon-warning-sign'></i> 标题在4~32位之间"  value="<?php echo ($blog["title"]); ?>" nullmsg="<i class='icon-warning-sign'></i> 请填写信息！" />
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            ...
            <!-- 实例化编辑器 -->
            <textarea  id="umeditor" name="content"><?php echo ($blog["content"]); ?> </textarea>
          </div>
          <div class="Validform_checktip">
             <div class="info">标题至少4个字符,最多32个字符<span class="dec"><s class="dec1">&#9670;</s><s class="dec2">&#9670;</s></span></div>
          </div>
         ...
         <div class="form-group">
          ...
          <div class="col-sm-8">
            <textarea name="introduction" class="form-control" rows="3" datatype="*4-120" errormsg="<i class='icon-warning-sign'></i> 描述在4~120位之间" nullmsg="<i class='icon-warning-sign'></i> 请填写信息！"><?php echo ($blog["introduction"]); ?></textarea>
          </div>
          <div class="Validform_checktip">
        ...
        <div class="form-group" id="form-lable">
          ...
          <div class="col-sm-8 input-lg">
              <input  type="text" class="form-control input-lg" name="tags" value="<?php echo ($blog["tags"]); ?>" id="tags" datatype="*1-24"  nullmsg="<i class='icon-warning-sign'></i> 请填写信息！"  />
          </div>
        </div>

        <br>
        <div class="form-group" id="form-lable">
          <label for="inputTag3" class="col-sm-0 control-label input-lg">地址</label>
          <div class="col-sm-8 input-lg">
              <input  type="text" class="form-control input-lg" name="request_url" value="<?php echo ($blog["request_url"]); ?>" id="tags" datatype="*1-24"  nullmsg="<i class='icon-warning-sign'></i> 请填写信息！"  />
          </div>
        </div>
       ...
       <div class="form-group">
          ...
          <div class="col-sm-3" id="net_img">            
              <textarea name="image_url" class="form-control" rows="6" id="image_url" datatype="url" errormsg="<i class='icon-warning-sign'></i> 图片链接无效" nullmsg="<i class='icon-warning-sign'></i> 请填写信息！"><?php echo ($blog["image_url"]); ?></textarea>
          </div>
           <div class="col-sm-1">            
          ...
          <div class="col-sm-3">            
               <img id="image_show" src="<?php echo ($blog["image_url"]); ?>" class="img-thumbnail img-size-1"/>
          </div>
        </div>
